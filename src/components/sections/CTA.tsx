      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-[#0F1A2E]/80 text-lg mb-8">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              {[
                ...
                <div key={index} className="flex items-center gap-2 text-[#0F1A2E]">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/orcamento"
                className="bg-[#0F1A2E] text-white px-8 py-4 rounded-xl font-semibold hover:bg-[#1B3B6C] transition-all flex items-center justify-center gap-2"
              >
                Solicitar Orçamento
